...
public final class AdministradorPacientes {
	...
	public boolean nuevoPaciente() {
		int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Introduzca Identificador:", "Nuevo Paciente", JOptionPane.QUESTION_MESSAGE));
        ...
        //registra un nuevo paciente dados los parámetros, el método sirve para agilizar el proceso de ingreso de datos. 
        public boolean nuevoPaciente1(int id,String nombre,String apellidos,String genero,int edad) {
	...
	public boolean modificarPaciente() {
		int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Introduzca Identificador del paciente a modificar:",
				"Modificar Paciente", JOptionPane.QUESTION_MESSAGE));
		/*
		 * Ahora se busca el paciente en el ArrayList y si lo encontramos lo referenciaremos
		...
		if (paciente == null) {
			...
			paciente.setId(Integer.parseInt(JOptionPane.showInputDialog(null, "ID actual: " + paciente.getId()
	...
	public boolean borrarPaciente() {
		int id = Integer.parseInt(JOptionPane.showInputDialog(null, "Introduzca Identificador del paciente a borrar:",
